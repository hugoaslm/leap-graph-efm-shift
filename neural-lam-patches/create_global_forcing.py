...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Start time for forcing generation (ISO string, e.g. 1979-01-01). "
        "If None, starts at first available timestep.",
    )
    parser.add_argument(
        "--time_end",
        type=str,
        default=None,
        help="End time for forcing generation (ISO string, e.g. 2022-12-31). "
        "If None, ends at last available timestep.",
    )
